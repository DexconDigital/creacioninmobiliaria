    ...
    <section id="quienes-somos" class="overflow-hidden">
        <div class="container pt-4 mt-4">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-lg-6 order-sm-2 order-md-1 wow fadeInLeft" data-wow-delay="0.6s">
            ...
            <div class="row pt-4 mt-4">
                ...
                <div class="col-12 col-lg-12 pt-4 mt-4 wow fadeInLeft" data-wow-delay="0.6s">
                    <h2>Visión</h2>
