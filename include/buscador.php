    ...
    <div class="container-fluid p-0">
        <form>
            ...
            <div class="row justify-content-center">
                ...
                $min ="<script>min</script>";

                ?>
                <div class="col-12 col-md-6 col-lg-auto form-group">
                    <input type="number" id="precio_minimo_buscar" value='<?php echo $min ?>' class="form-control" placeholder="Precio Mínimo">
                </div>

                <div class="col-12 col-md-6 col-lg form-group">
                    <input type="number" id="precio_maximo_buscar" value='<?php echo $min ?>' class="form-control" placeholder="Precio Máximo">
                </div>
                <div class="col-12 col-md-6 col-lg form-group">
