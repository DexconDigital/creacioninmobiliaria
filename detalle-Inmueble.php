                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-1">
                                <ul class="row align-items-center justify-content-center pl-0 pr-0 list-style-none">
                                    ...
                                    <li class="col-auto col-md-auto"><a href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.creacioninmobiliaria.com%2Fdetalle-inmueble.php%3Fco%3D<?php echo $codigo; ?>" target="_blank"><img src="images/facebook.png" alt="" style="height: 25px;"></a></li>
                                    <li class="col-auto col-md-auto "><a href="<?php echo 'https://twitter.com/intent/tweet?url=http%3A%2F%2Fwww.creacioninmobiliaria.com%2Fdetalle-inmueble.php%3Fco%3D' . $codigo . '&text=' . $r['Tipo_Inmueble'] . '%20en%20' . $r['Gestion'] . '%20en%20' . $r['ciudad'] . '-' . $r['depto'] ?>" target="_blank"><img src="images/twitter.png" alt="" style="height: 25px;"></i></a></li>
                                    <li class="col-auto col-md-auto d-md-none m-top"><a href="<?php echo 'https://wa.me/?text=' . $r['Tipo_Inmueble'] . '%20en%20' . $r['Gestion'] . '%20en%20' . $r['ciudad'] . '-' . $r['depto'] . '%20http://www.creacioninmobiliaria.com/detalle-inmueble.php?co%3d' . $codigo ?>" target="_blank"><img src="images/whatsapp.png" alt="" style="height: 25px;"></a></li>
                                </ul>
                            </div>
